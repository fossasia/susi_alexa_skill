      ...
      case "IntentRequest":
        ...
        switch(event.request.intent.name) {
          case "callSusiApi":
            ...
            var viewCount;
            if(event.request.intent.slots.query.value === 'help'){
              viewCount = 'Ask me almost anything. I can tell you distance between two countries, acronyms , value of a bitcoin or any other thing. I wil be happy to help. So, start asking me.';
            }
            else if (event.request.intent.slots.query.value === 'stop' || event.request.intent.slots.query.value === 'cancel'){
