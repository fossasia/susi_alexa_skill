...
openssl aes-256-cbc -K $encrypted_6f11b2726b3d_key -iv $encrypted_6f11b2726b3d_iv -in ./kubernetes/travis/susi-telegrambot-85cf0ec296e9.json.enc -out susi-telegrambot-85cf0ec296e9.json -d
mkdir -p lib
